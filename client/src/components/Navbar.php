<nav class="global-navbar">
  <span>
    ...
    <input id="search-input" class="w-full border pl-1 pr-4 py-2 focus:border-blue-500 focus:outline-none focus:shadow-outline" 
      type="text" placeholder="Search" onkeyup="changeSearch(this)">
