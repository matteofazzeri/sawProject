<nav class="global-navbar">
  ...
  <a href="http://localhost/sawProject/client/"><img src="./public/img/new_logo.png" width="75px"></a>
  ...
  <div class="left-nav">
    ...
    <div id="profile" class="profile-btn">
      ...
      <div class="popup-menu">
        ...
        <?php
          if(isLogged()){
            echo '<a href="profile">View profile </a><br>';
            if(isAdmin())
              echo '<a href="private">Private Area</a><br>';
          } else echo '<a href="login">Login</a><br>';
        ?>
        <a href="cart">
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
